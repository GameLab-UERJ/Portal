...
> Este documento lista todos os integrantes ativos do laboratório.
> Para entender as responsabilidades detalhadas de cada cargo e os critérios de nível (Júnior, Pleno, Sênior), consulte o nosso [Guia de Diretrizes](./diretrizes.md).

---

## ⏰ Dedicação e Grade de Sincronismo

Para garantir o alinhamento das equipes e facilitar o agendamento de pareamentos ou reuniões internas, os membros dedicam a meta recomendada de **6h semanais** ao laboratório nos seguintes turnos:

- **Breno Santana:** Segunda, Quarta e Sexta — das 08h às 10h (Total: 6h)
- **[Nome]:** Terça e Quinta — das 14h às 17h (Total: 6h)
- **[Nome]:** Segunda e Quarta — das 19h às 22h (Total: 6h)

---

## 🏛️ Coordenação e Liderança Geral
